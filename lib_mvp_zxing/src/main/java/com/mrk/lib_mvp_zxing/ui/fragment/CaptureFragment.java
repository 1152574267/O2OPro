package com.mrk.lib_mvp_zxing.ui.fragment;
...
import com.mrk.lib_mvp_zxing.camera.CameraManager;
import com.mrk.lib_mvp_zxing.contract.XdjaCaptureContract;
import com.mrk.lib_mvp_zxing.decoding.CaptureActivityHandler;
import com.mrk.lib_mvp_zxing.decoding.InactivityTimer;
import com.mrk.lib_mvp_zxing.utils.CodeUtils;
import com.mrk.lib_mvp_zxing.view.ViewfinderView;
 ...
 * 自定义实现的扫描Fragment
 */
public class CaptureFragment extends Fragment implements SurfaceHolder.Callback, XdjaCaptureContract.XdjaCaptureView {
    static final String TAG = CaptureFragment.class.getSimpleName();
